        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.number} className="rounded-3xl bg-[#efede7] p-8">
              ...
              <div className="rounded-2xl border border-gray-300 bg-white p-6 lg:col-span-2">
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  {["Async video standups with AI summaries", "Slack + Notion integrations", "Team health dashboard", "AI blocker detection"].map((item) => (
                    <div key={item} className="rounded-xl border border-gray-200 bg-[#fafafa] px-4 py-4 text-sm text-gray-700">{item}</div>
                  ))}
                </div>
              </div>
              <div className="rounded-2xl border border-gray-300 bg-white p-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={t.name} className="rounded-3xl border border-gray-200 bg-white p-8">
